            ...
            <Layout>
                ...
                {registro && Object.entries(registro).length !== 0 ? (
                    <View style={styles.container}>
                        ...
                        <Text style={styles.itemTitle}>¿Ha tomado la medicación correspondiente a la mañana?: {medicacionManana}</Text>
                        <Text style={styles.itemTitle}>¿Ha tomado la medicación correspondiente a la tarde?: {medicacionTarde}</Text>
                        <Text style={styles.itemTitle}>¿Ha tomado la medicación correspondiente a la noche?: {medicacionNoche}</Text>
